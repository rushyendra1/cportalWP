...
[/insert_php]
<input type="hidden" id="rand" value="[insert_php] echo $rand[/insert_php]">
...
<div class="bodyCell contentSub row-fluid" >
  <div class="row toggle-full-width">
    <div class="bPageTitle">
      ...
      <h4 class="headTitle">[insert_php] echo $title; [/insert_php]</h4>
      ...
      <div id="section_1">
          ...
          <div class="medium-6 columns">
              <label for="newPwd">
                <strong data-tooltip aria-haspopup="true" class="fi-info has-tip radius" title="Enter New Password.&lt;br&gt;&lt;small&gt;&lt;em&gt;This field is required.&lt;/em&gt;&lt;/small&gt;"> 
                  New Password*</strong>
                <input type="password" maxlength="[insert_php] echo $max_pass_len [/insert_php]" id="newPwd" name="newPwd" placeholder="New Password" class="radius" required tabindex="1">
          ...
          <div class="medium-6 columns">
            <label for="confirmPwd">
                ...
                <input type="password" id="confirmPwd" name="confirmPwd" placeholder="Confirm New Password" class="radius"  maxlength="[insert_php] echo $max_pass_len [/insert_php]" tabindex="2" >
              <span class="label error alert radius" style="display:none">Required</span>
              <span class="correctPassword" style="display:none" ><img class="imageShown" src="[insert_php] echo get_template_directory_uri() [/insert_php]/img/correct1.png"  ></span>
            </label>
          </div>
