...
<div class="bodyCell contentSub row-fluid objectmainContentDisp" >
          ...
          <div class="medium-6 columns">
            <label for="oldPwd">
                <strong data-tooltip aria-haspopup="true" class="fi-info has-tip radius" title="Enter Old Password.&lt;br&gt;&lt;small&gt;&lt;em&gt;This field is required.&lt;/em&gt;&lt;/small&gt;"> 
                  Old Password*</strong>
                <input type="password" maxlength="[insert_php] echo $max_pass_len; [/insert_php]" id="oldPwd" name="oldPwd" placeholder="Old Password" class="radius" required tabindex="1">
          ...
          <div class="medium-6 columns">
              <label for="newPwd">
                <strong data-tooltip aria-haspopup="true" class="fi-info has-tip radius" title="Enter New Password.&lt;br&gt;&lt;small&gt;&lt;em&gt;This field is required.&lt;/em&gt;&lt;/small&gt;"> 
                  New Password*</strong>
                  <input type="password" maxlength="[insert_php] echo $max_pass_len; [/insert_php]" id="newPwd" name="newPwd" placeholder="New Password" class="radius" required tabindex="2">
              <span class="label error alert  radius" style="display:none">Required</span>
