...
if($status){
    ...
    $user_query = @pg_query($db,"SELECT id,name "
            . " FROM contacts"
            . " WHERE pwd_activation_code='".$id."'");
    $res = @pg_fetch_assoc($user_query);
    $id = $res['id'];
    if(is_bool($res) || is_null($res))
    {
    ...
    <div class="large-12 columns">
      ...
      <div id="section_1">
          ...
          <div class="columns small-12"> 
            ...
            <a  id="changePwdSubmit" class="button radius submit link">Submit</a> <br>
          </div>
        </div>
