...
?>
                        ...
                        if (is_user_logged_in()) {
                            ...
                            if (count($response_array) > 0) {
                                ...
                                //$tab_array = array("link1", "link2","link3","link4","link5","link6","link7","link8","link9","link10","link11");

                                $api_array = $response_array['ApiList'];
                                //$api_array = array("link1", "link2","link3","link4","link5","link6","link7","link8","link9","link10","link11");
                                $i = 0;
                                $j = 0;
                                $limit =8;
                                for ($i = 0; $i <= $limit; $i++) {
