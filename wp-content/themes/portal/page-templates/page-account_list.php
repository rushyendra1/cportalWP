<?php
/**
 * Template Name: Page Account List
 * @package WordPress
 * @subpackage Portal
 * @since Portal 1.0
 */
                ...
                <div class="bodyCell contentSub" >
                    ...
                    <div class="bodyPage">
                        <div class="bPageTitle">
                            <h1 class="pageType noSecondHeader"></h1>
                        ...
                        <!-- Alphabet Pagination -->
                            ...
                            <div class="alphaDiv row-fluid">
                                <?php foreach (range('A', 'Z') as $char) { ?>
                                    <a  class="listItem alphaAccount" data-alphatype="<?php echo $char ?>" ><span class="listItemPad"><?php echo $char ?></span></a>
<?php } ?>
                                <!--<a  class="listItem alphaAccount" data-alphatype="other">
                                    <span class="listItemPad">Other</span>
                                </a>-->
                                <a class="listItem alphaAccount activeAlpha" data-alphatype="all" >
                            ...
                            <div class="accountListDiv">
                                ...
                                <div class="pbBody">
                                    <table cellspacing="0" cellpadding="0" border="0" class="list accountListTable">
                                        <thead class="displayAccountHeader">

                                        </thead>
                                        <tbody class="account-list-res">
                                    ...
                                    <div class="fewerMore">
                                        Show me <a class="fewerAccount activeCont" data-type="0">fewer
                                        ...
                                        /  
                                        <a class="moreAccount" data-type="1">
